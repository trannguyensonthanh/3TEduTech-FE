// src/components/admin/promotions/DeletePromotionDialog.tsx
      ...
      <DialogContent className='sm:max-w-md'>
        <DialogHeader className='text-center items-center'>
          ...
          <DialogDescription className='text-balance'>
            ...
            {promotion.promotionName}"? This will permanently remove the code{' '}
            <b className='font-mono'>{promotion.discountCode}</b> and this
