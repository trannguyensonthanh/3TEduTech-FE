        ...
        >
          <div className="text-center sm:text-left mb-6 sm:mb-0">
            ...
            <p className="mt-3 text-lg md:text-xl text-muted-foreground max-w-xl">
              Handpicked courses to kickstart your learning journey with our top
              instructors.
            </p>
          </div>
          <Button
        ...
        {!isLoading && !error && featuredCourses.length > 0 && (
          ...
          >
            {featuredCourses.map((course) => (
              // CourseCard đã có motion.div bên trong, không cần bọc motion.div ở đây nữa
              // nếu itemVariants được áp dụng trực tiếp trong CourseCard.
              // Nếu không, bọc motion.div ở đây:
              // <motion.div key={course.courseId} variants={itemVariants}>
              //  <CourseCard course={course} />
              // </motion.div>
              // Hoặc truyền variants vào CourseCard nếu bạn muốn.
              // Để đơn giản, CourseCard tự quản lý animation của nó.
